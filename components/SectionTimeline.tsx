...
const SECTIONS: Section[] = [
  ...
  { id: "mode1-designs",           label: "Mode 1: BEFORE Screens", number: "06" },
  { id: "mode2-designs",           label: "Mode 2: DURING Screens", number: "07" },
  { id: "mode3-designs",           label: "Mode 3: AFTER Screens",  number: "08" },
  { id: "decisions-system",        label: "System Decisions",       number: "09" },
  { id: "information-architecture",label: "Info Architecture",      number: "10" },
  { id: "design-system",           label: "Design System",          number: "11" },
  { id: "problem-evolution",       label: "Problem Evolution",      number: "12" },
  { id: "iterations",              label: "Iterations",             number: "13" },
  { id: "validation",              label: "Validation & Testing",   number: "14" },
  { id: "monetization",            label: "Business Model",         number: "15" },
  { id: "constraints",             label: "Constraints",            number: "16" },
  { id: "reflection",              label: "Reflection",             number: "17" },
  { id: "video",                   label: "Video Walkthrough",      number: "18" },
  { id: "prototype",               label: "Prototype",              number: "19" },
];
...
const SCROLL_MAP: { id: string; visibleIndex: number }[] = [
  ...
  { id: "mode1-designs",           visibleIndex: 5 },
  { id: "decisions-mode1",         visibleIndex: 5 },
  { id: "mode2-designs",           visibleIndex: 6 },
  { id: "decisions-mode2",         visibleIndex: 6 },
  { id: "mode3-designs",           visibleIndex: 7 },
  { id: "decisions-mode3",         visibleIndex: 7 },
  { id: "decisions-system",        visibleIndex: 8 },
  { id: "information-architecture",visibleIndex: 9 },
  { id: "design-system",           visibleIndex: 10 },
  { id: "problem-evolution",       visibleIndex: 11 },
  { id: "iterations",              visibleIndex: 12 },
  { id: "validation",              visibleIndex: 13 },
  { id: "monetization",            visibleIndex: 14 },
  { id: "constraints",             visibleIndex: 15 },
  { id: "reflection",              visibleIndex: 16 },
  { id: "video",                   visibleIndex: 17 },
  { id: "prototype",               visibleIndex: 18 },
];
