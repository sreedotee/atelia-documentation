...
const SECTIONS: Section[] = [
  ...
  { id: "decisions-mode1",         label: "Decisions · Mode 1",    number: "09" },
  { id: "mode2-designs",           label: "Mode 2: DURING",        number: "10" },
  { id: "decisions-mode2",         label: "Decisions · Mode 2",    number: "11" },
  { id: "mode3-designs",           label: "Mode 3: AFTER",         number: "12" },
  { id: "decisions-mode3",         label: "Decisions · Mode 3",    number: "13" },
...
const SCROLL_MAP: { id: string; visibleIndex: number }[] = [
  ...
  { id: "decisions-mode1",         visibleIndex: 6 },
  { id: "mode2-designs",           visibleIndex: 7 },
  { id: "decisions-mode2",         visibleIndex: 8 },
  { id: "mode3-designs",           visibleIndex: 9 },
  { id: "decisions-mode3",         visibleIndex: 10 },
  { id: "decisions-system",        visibleIndex: 11 },
  { id: "information-architecture",visibleIndex: 12 },
  { id: "design-system",           visibleIndex: 13 },
  { id: "problem-evolution",       visibleIndex: 14 },
  { id: "iterations",              visibleIndex: 15 },
