    ...
    <section id="competitive-landscape" className="py-28 bg-white dark:bg-[#1e1530]">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {approaches.map((a, i) => (
            ...
            >
              ...
              <h3 className="font-clash text-base md:text-lg lg:text-xl font-medium text-[#1D1A1C] dark:text-white mb-5">
                {a.title}
              </h3>
        ...
        >
          ...
          <div>
            <h4 className="font-clash text-base md:text-lg lg:text-xl font-medium text-[#1D1A1C] dark:text-white mb-2">
              The Gap
            </h4>
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <h3 className="font-clash text-base md:text-lg lg:text-xl font-medium text-[#1D1A1C] dark:text-white mb-6">
