    ...
    <section id="card-sorting" className="py-28 bg-white dark:bg-[#1e1530]">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
          ...
          >
            <div className="flex items-center gap-2 mb-5">
              ...
              <h3 className="font-clash text-sm md:text-base lg:text-lg font-medium text-[#1D1A1C] dark:text-white">
        ...
        >
          ...
          <div>
            <h4 className="font-clash text-sm md:text-base lg:text-lg font-medium text-[#1D1A1C] dark:text-white mb-2">Validated</h4>
