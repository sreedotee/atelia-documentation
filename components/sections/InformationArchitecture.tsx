...
export default function InformationArchitecture() {
  ...
  return (
    <section id="information-architecture" className="py-28 bg-[#FAF9FA]">
      <div className="max-w-[1200px] mx-auto px-6">
        <SectionHeader number="15" title="Information Architecture" />
        ...
        >
          ...
          <div className="flex justify-center mb-4">
            <div className="px-8 py-3 bg-[#1D1A1C] text-white rounded-xl font-clash font-medium text-lg">
              ATELIA
            </div>
          </div>
          <div className="flex justify-center mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {principles.map((p) => (
              <div key={p} className="flex items-start gap-2">
                ...
                <p className="text-[#5C5759] text-sm">{p}</p>
              </div>
            ))}
          </div>
        </motion.div>
